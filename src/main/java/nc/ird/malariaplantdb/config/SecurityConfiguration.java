...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/compilers/**").permitAll()
            .antMatchers("/api/inVivoPharmacos/**").permitAll()
            .antMatchers("/api/inVitroPharmacos/**").permitAll()
            .antMatchers("/api/plantIngredients/**").permitAll()
